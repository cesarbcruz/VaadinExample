...
public class OcorrenciaTable extends Table {
    ...
    private void configColumns() {
        setVisibleColumns(new Object[]{"id", "nome", "descricao", "dataHora", "tipoOcorrencia"});
        setColumnHeaders(new String[]{"#", "Nome", "Descrição", "Data Hora", "Tipo"});
        addGeneratedColumn("dataHora", new DateColumnGenerator());
    }
